//
//CODIGO PARA EL SENSOR DE PULSO 
//
...
SoftwareSerial BTSerialP(3, 2); // RX | TX (cruzar en blutu) // MASTER
int datoP = 1 ;// variable para enviar el dato del pulso 
...
void setup()
{
  BTSerialP.begin(9600);//inicializamos modulo blutu
...
void loop()
{
  ...
  BTSerialP.write(datoP);// enviamos el dato por el monitor serie
